...
import { FaBuilding, FaUsers, FaRupeeSign, FaFileAlt, FaTimesCircle, FaHourglassHalf, FaCheckCircle } from 'react-icons/fa'
  ...
  return (
    <div className='p-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
            ...
            <SummaryCard icon ={<FaRupeeSign />} text="Monthly Salary" number={`₹50000`} color="bg-red-600"/>
        </div>
